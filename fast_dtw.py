...
ts1 = np.array([0.57311057,0.66785286,0.6204376,0.64280256,0.69667441,0.60423623,0.64343652,0.61178161,0.57311057,0.66785286,0.6204376,0.64280256,0.69667441,0.60423623,0.64343652,0.61178161])
ts2 = np.array([0.61543759,0.58163419,0.62914481,0.62535561,0.62036891,0.61944155,0.63006706,0.58448635,0.61543759,0.58163419,0.62914481,0.62535561,0.62036891,0.61944155,0.63006706,0.58448635])
...
def calc_path(shrunk_x,shrunk_y,radius,distance="ecludian"):
    cost,path = fast_dtw(shrunk_x,shrunk_y,radius,distance="ecludian")
    return path
